...
final class GlobalGroupState {
  ...
  GlobalGroupState(@Nullable DecryptedGroup localState, @NonNull List<ServerGroupLogEntry> serverHistory, @NonNull GroupHistoryPage.PagingData pagingData) {
    this.localState = localState;
    this.serverHistory = serverHistory;
    this.pagingData = pagingData;
  }

  GlobalGroupState(@Nullable DecryptedGroup localState, @NonNull List<ServerGroupLogEntry> serverHistory) { this(localState, serverHistory, GroupHistoryPage.PagingData.NONE); }
  ...
  public boolean hasMore() { return pagingData.hasMorePages(); }
