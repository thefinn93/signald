...
public class ExpandedPushServiceSocket {
    ...
    public ExpandedPushServiceSocket(SignalServiceConfiguration configuration,
    ...
    /*
     * The rest of this class is helpers mostly copied from libsignal's PushServiceSocket
     */
