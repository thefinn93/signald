...
for v2 group features like removing members, see [`v1.update_group`](https://docs.signald.org/actions/v1/update_group/).
...
|-------------------|----------|----------|-------------|
| `username`        | `string` | yes      | The account to use. |
| `recipientAddress` | [`JsonAddress`](https://docs.signald.org/structures/v1/JsonAddress/) | yes      | The number of the user who's profile is being checked. |


### `set_profile`

note: [`set_profile` v1](https://docs.signald.org/actions/v1/set_profile/) supports setting avatar.
...
React to a message. For details see the [`JsonReaction`](https://docs.signald.org/structures/v1/JsonReaction/) wiki page.
